...
public class TestParseElement {
	...
	private List<TestParseElement> children = new ArrayList<TestParseElement>();
	...
	public List<TestParseElement> getChildren() {
		return children;
	}

	public void setChildren(List<TestParseElement> children) {
	...
	public TestParseElement clone() {
		TestParseElement clone = new TestParseElement();
		clone.setCode(code);
